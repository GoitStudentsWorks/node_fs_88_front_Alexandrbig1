import{u as t,p as v,c as C,j as o,l as ne,r as h,d as ae,B as L,e as $,f as ie,g as U,h as se,i as _,N as le,b as ce,k as V,m as F,n as P,s as q,o as de,q as he,t as me,H as pe,a as ue,O as xe}from"./index-BBg1oyKG.js";import{L as ge}from"./Logo-XG7v1qVP.js";import{G as k}from"./iconBase-eLb89l_S.js";import{I as B,P as b,F as K,a as T,c as O,b as j,s as A,d as Z,E as X,C as G,e as Q,u as fe,f as ye}from"./selectors-L23WtUmC.js";import{e as Y,B as ve,a as we}from"./index-IJc0yXok.js";import"./hoist-non-react-statics.cjs-VBt2Fl8Z.js";function be(e){return k({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"},child:[]}]})(e)}const ke=t(be)`
  font-size: 3.2rem;
...
`,Re=t(Ae)`
  ...
  color: ${e=>e.theme.colors.mainTextColor};
  margin-right: 8px;
`,Ue=()=>{const[e,r]=h.useState(!1),n=()=>{r(s=>!s)};return o.jsxs(o.Fragment,{children:[o.jsxs(Fe,{children:[o.jsx(Pe,{children:o.jsx("img",{src:"images/flower.png",alt:"flower"})}),o.jsxs(We,{children:["If you need help with ",o.jsx(De,{children:"TaskPro"}),", check out our support resources or reach out to our customer support team."]}),o.jsxs(Ne,{onClick:()=>n(),children:[o.jsx(Re,{}),"Need help?"]})]}),e&&o.jsx(J,{openHelpModal:n})]})},_e=Ue,M="/node_fs_88_front_Alexandrbig1/assets/icons-EKrRu2KP.svg",Ve=t(K)`
  margin: 0;
  position: relative;
`,W=t.p`
  color: ${e=>e.theme.colors.secondaryTextColor};
...
`,Jo=()=>{const[e,r]=h.useState(!1),[n,s]=h.useState(!1),[c,d]=h.useState(""),l=ce(),u=C(),i=V(),y=$(A),p=x=>{u(_(x))},g=()=>{r(x=>!x)},a=x=>{d(x),s(m=>!m)};h.useEffect(()=>{u(F())},[u]);const f=x=>{u(P(x)).then(m=>{m.type===P.fulfilled.type?(u(F()),l("/home")):console.log("Виникла помилка під час завантаження даних:")})};return o.jsxs(No,{children:[o.jsxs(Do,{children:[o.jsx(Ro,{children:"My boards"}),o.jsxs(Uo,{children:[o.jsx(_o,{children:"Create a new board"}),o.jsx(Vo,{onClick:()=>g(),children:o.jsx(qo,{})})]}),e&&o.jsx(po,{openNewBoardModal:g})]}),o.jsx(Ko,{children:y.map(({_id:x,icon:m,titleBoard:w})=>o.jsx("li",{onClick:()=>p(x),children:o.jsxs(Zo,{to:`/home/${w}`,state:{from:i},children:[o.jsxs(Go,{children:[o.jsx(H,{children:o.jsx("svg",{width:"18",height:"18",children:o.jsx("use",{href:`${M}#${m}-dark`})})}),o.jsx(I,{children:w})]}),o.jsxs(Xo,{children:[o.jsx(Qo,{onClick:()=>a(x)}),o.jsx(Yo,{onClick:()=>f(x)})]})]})},x))}),n&&o.jsx(Fo,{openEditBoardModal:a,boardId:c})]})},et=Jo,ot=t.aside`
...
`;function it({aside:e,handleAsideHide:r}){const[n,s]=h.useState(!1),c=h.useRef();h.useEffect(()=>{const l=c.current,u=()=>{s(l.scrollTop>0)};return l.addEventListener("scroll",u),()=>{l.removeEventListener("scroll",u)}},[]);function d(l){l.target.localName==="aside"&&r()}return o.jsx(ot,{$aside:e,onClick:l=>d(l),children:o.jsxs(tt,{ref:c,$aside:e,$scrollable:n,children:[o.jsx(at,{onClick:r}),o.jsxs("div",{children:[o.jsx(rt,{children:o.jsx(ge,{})}),o.jsx(et,{})]}),o.jsxs(nt,{children:[o.jsx(_e,{}),o.jsx($e,{})]})]})})}function st(e){return k({tag:"svg",attr:{version:"1.2",baseProfile:"tiny",viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M19 17h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2zM19 10h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2zM19 3h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2z"},child:[]}]})(e)}const lt=t.div`
  display: block;
  cursor: pointer;
...
`;function Pt(){const[e,r]=h.useState(!1),n=$(q);function s(){r(c=>!c)}return o.jsxs(o.Fragment,{children:[o.jsx(It,{children:o.jsxs(Ft,{onClick:()=>s(),children:[o.jsx(Ht,{children:n.name}),n.avatarURL&&n.avatarURL!=="default"?o.jsx(Ot,{src:n.avatarURL,alt:"User Avatar"}):o.jsx(At,{children:o.jsx("use",{href:"images/icons.svg#icon-userAvatarDefault"})})]})}),e&&o.jsx(Mt,{toggleModal:s})]})}const Wt=t.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  padding: 1.8rem 2rem;
