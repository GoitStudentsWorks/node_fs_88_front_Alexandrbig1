import{u as n,p as s,j as i}from"./index-BBg1oyKG.js";const l=n.a`
...
`;function h({size:o,text:e,icon:t}){return i.jsx("div",{children:i.jsxs(l,{href:"#/home",children:[i.jsxs(r,{size:o,icon:t,children:[i.jsx("use",{id:"logo1",href:"images/icons.svg#icon-logo-path1"}),i.jsx("use",{id:"logo2",href:"images/icons.svg#icon-logo-path2"})]}),i.jsx(c,{$text:e,children:"Task Pro"})]})})}export{h as L};
